...
import static key.Security.byteArrayToHexaString;
...
public class main {
	...
	public static void main(String[] args) throws Exception {
		...
		String encryptedNum = byteArrayToHexaString(encrypted);
		...
		String decryptedNum = byteArrayToHexaString(decrypted);
